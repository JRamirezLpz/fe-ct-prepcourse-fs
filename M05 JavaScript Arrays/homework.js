...
function todosIguales(array) {
   ...
   return array.every(elem => elem === elementos) ? true : false;
}
...
function mesesDelAño(array) {
   ...
   // Tu código:
   var meses = [];
   var mesesSelect = ["Enero", "Marzo", "Noviembre"];
   array.forEach(elem => {
      if(mesesSelect.includes(elem)) {
         meses.push(elem);
      }
   })
   if(meses.length === 3) {
